...
import {
  anchorTransform, GRAND_STAFF_BOX, SINGLE_STAFF_BOX, type StaffBox,
} from './staff-anchor';
...
describe('anchorTransform — neo dòng kẻ trên cùng', () => {
  ...
  it('nốt quá cao thì thu nhỏ vừa khung chứ không bị cắt', () => {
    // Si7 khóa Sol: cần 139px dòng kẻ phụ phía trên, mà chỗ neo chỉ có 95px.
  ...
  it('nốt quá trầm cũng thu nhỏ, tính theo phía dưới', () => {
    // Đô1 khóa Pha: dòng kẻ phụ kéo xuống 156px, chỗ dưới neo chỉ có 125px.
