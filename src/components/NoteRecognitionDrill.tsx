...
import { staffBox } from '@/lib/staff-anchor';
import { STAFF_BOX_PADDING_Y, useDrillStaff } from '@/hooks/useDrillStaff';
...
export function NoteRecognitionDrill() {
  ...
  /**
   * Vẽ khuông nhạc và neo nó lại. Toàn bộ phần đụng tới abcjs — kể cả gần hết
              ...
              */}
              <div
                ...
                style={{
                  ...
                  borderRadius: 16,
                  // Padding dọc phải khớp `STAFF_BOX_PADDING_Y` — phép phóng lúc tập
                  // trung trừ đúng con số này ra khỏi chiều cao đo được, nên suy thẳng
                  // từ nó thay vì hai chỗ tự nhớ lấy nhau.
                  padding: `${STAFF_BOX_PADDING_Y / 2}px 1rem`,
                  /*
