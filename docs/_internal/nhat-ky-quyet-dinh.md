...
| Bài luyện nhận nốt có tám ô chọn — bày hết ra hay gom thành mức độ? | **Bốn mức dựng sẵn (Dễ / Trung bình / Khó / Rất khó) đứng trên cùng, tám ô chi tiết gộp vào nút *Tuỳ chọn*.** Mức suy ra từ lựa chọn, không lưu riêng | Tám ô nhân với nhau ra một không gian mà người mới không có cách nào dò: hoặc để nguyên mặc định mãi, hoặc bật đại một thứ quá sức rồi tưởng mình dốt. Thang khó **bám theo lộ trình giáo trình** chứ không bịa cho đủ bốn — Dễ là tầm Chương 1, Trung bình là Chương 2-3 (bước mới: đọc hai khuông), Khó là Chương 4-6 (cả ô nhịp, hoá biểu đổi mỗi câu), Rất khó là sau Chương 7 (chồng nốt như hợp âm). Mỗi bậc chỉ thêm hai tới ba thứ: thêm một thì bốn bậc không trải hết tám ô, thêm năm thì bậc nào cũng hụt hơi. **Mức suy ra chứ không lưu riêng** vì lưu riêng thì hai thứ lệch được — chỉnh tay một ô rồi mở lại app vẫn thấy ghi "Khó" trong khi lựa chọn đã khác hẳn. *Tuỳ chọn* chỉ MỞ bảng ra chứ không đổi gì, để lấy một mức làm điểm xuất phát rồi sửa một thứ. Đo được: thẻ bảng chọn từ 1237px xuống 278px ở mức Dễ, tức là khuông nhạc lên thẳng màn hình đầu thay vì phải cuộn qua cả trang ô chọn |
| Xoay ngang máy thì thanh điều hướng để đâu? | **Dời sang cạnh TRÁI, đứng dọc, thu còn biểu tượng.** Bấm mũi tên thì mở rộng có nhãn chữ và **đẩy nội dung dạt ra**, không đè lên. Chỉ áp cho màn hình thấp mà rộng (`max-height: 540px`), máy tính bảng giữ nguyên thanh dưới đáy | Xoay ngang là lúc **chiều cao** thành thứ khan hiếm nhất — điện thoại còn khoảng 360px, mà dải ngang 76px ăn hơn một phần năm. Bề ngang thì đang thừa, nên dời sang cạnh là trả lại đúng thứ đang thiếu bằng thứ đang thừa; đo được: chỗ trống dưới đáy của nội dung từ 108px xuống 32px. Mép **trái** vì xoay ngang thì hai tay ôm hai cạnh máy và tay phải còn đang chực cuộn. **Đã thử rồi bỏ kiểu ĐÈ lên nội dung** (giữ bề ngang nội dung cố định, thanh mở rộng phủ lên): nhìn ảnh chụp mới thấy thanh 172px che mất mảng bên trái, mà bên trái là chỗ mọi dòng chữ bắt đầu — tiêu đề thẻ bị cụt đúng phần đầu câu. Đổi sang đẩy nội dung, dùng `:root:has(.tab-bar[data-expanded])` để một thẻ con báo ngược lên biến bề ngang; trình duyệt chưa có `:has()` thì tự quay về kiểu đè, vẫn dùng được |
| Thêm tính năng gì để app dạy được nhiều hơn? | **Luyện tai** (`/ear-trainer`): app phát một câu, người học mò trên đàn thật, app **chỉ nói cao hơn / thấp hơn**, không nói tên nốt | Cả app trước đó dạy đúng một chiều **mắt → tay**; không có gì dạy **tai → tay**. Với người tự học không có thầy, đó lại chính là thứ họ muốn làm được (nghe một bài rồi mò ra nó) và là thứ không ai rèn cho họ. Ba quyết định bên trong: (1) **không nói tên nốt lúc đang mò** — tên nốt là câu trả lời, mà việc cần rèn nằm ở đoạn đi tìm; chỉ nói hướng, đúng thứ một người thầy nói, và nó dạy ra cảm giác quãng. (2) **Không mách micro nốt đang hỏi**, khác hẳn bài luyện nhận nốt: ở đó nốt hiện sẵn trên màn hình nên gợi ý chỉ giúp nghe rõ hơn, còn ở đây nốt là bí mật — mách vào là micro thiên vị đúng cái nốt chưa tìm ra và lời chỉ đường sẽ chỉ SAI, tệ hơn cả không có lời chỉ đường nào. (3) **Nghe lại không giới hạn**, và nói thẳng rằng số lần bấm thử không phải điểm trừ — người không dám mò là người bỏ cuộc |
| Bài tập ôn luyện lấy ở đâu: kho nhạc cổ điển miễn phí, hay nhờ AI sáng tác, hay tự sinh bằng luật? | **Tự sinh bằng luật** (`src/lib/exercise-gen.ts`) cho Chương 1-5. Kho nhạc vẫn dùng, nhưng cho bài hát ở `/songs` chứ không cho bài tập | Đã đi tìm kho thật rồi mới chốt: **không có kho miễn phí nào ở tầm này.** Thế tay 5 ngón một vị trí là phát minh của sách phương pháp hiện đại, còn nhạc cổ điển thật bắt đầu từ chỗ hai tay đi khắp bàn phím — kho Mutopia có 324 nhạc sĩ nhưng bản dễ nhất (Czerny op. 821) đã chạy từ Đô3 tới La6 với nốt móc kép, và các sách vỡ lòng đúng tầm (Beyer, Köhler, Le Couppey) không có trong kho nào lấy được. **Vì sao không nhờ AI sáng tác:** bài tập ở tầm này không cần hay, nó cần **đúng ràng buộc** — đúng tầm nốt của chương, đúng hình nốt đã dạy, đủ phách mỗi ô nhịp. Ràng buộc thì kiểm được bằng test và sai là đỏ ngay; nhạc do AI sinh thì phải nghe từng bài, lại không có quyền tác giả nên ai chép cũng được. Cùng một `seed` thì ra cùng một bài trên mọi máy, nên trang dựng ở máy chủ không lệch máy người học và gắn được một bài tập cố định vào một bài học |
| Thư viện vẽ bản nhạc (abcjs) còn ổn không, hay nên đổi sang thư viện khác? | **Giữ abcjs, ghim đúng `6.7.0` không có dấu `^`.** Thứ phải làm là co đường ra vào nó lại: bốn file là toàn bộ chỗ nhập thư viện | Câu hỏi thật đằng sau là "sau này tích hợp công cụ khác hay cho người ngoài soạn nhạc thì có vướng không". Đổi thư viện lúc này là đổi toàn bộ nội dung đã soạn (mọi khối ```abc trong giáo trình) để lấy một thứ chưa ai cần tới. Rủi ro thật nằm chỗ khác: **bẫy 28-33 đều bám vào chi tiết bên trong abcjs**, mà chi tiết đó đổi thì cả năm lệnh kiểm vẫn xanh và chỉ bản nhạc trên màn hình là sai — nên ghim phiên bản, và tách thành cửa vẽ (`useSheetRender`) với cửa tiếng (`useSheetAudio`) để sau này đổi thì chỉ sửa sau cửa. Đường nhập nhạc từ ngoài vào (MusicXML) cũng đi qua cùng chỗ đó |
| Bài luyện nhận nốt: mở hết cho mọi người hay chặn theo gói? | **Mở mức Dễ cho tất cả, ba mức sau và bảng *Tuỳ chọn* theo gói Nền tảng.** Luật ở `canUseDrillPreset` (`src/lib/access.ts`) | Ranh giới này **trùng đúng ranh giới nội dung** chứ không phải hàng rào mới: thang khó của bài luyện vốn bám theo lộ trình giáo trình (Dễ là tầm Chương 1, Trung bình là Chương 2-3, Khó là Chương 4-6, Rất khó là sau Chương 7), nên người chưa mở gói tập đúng phần họ đã được học. Ba chỗ dễ làm sai, đã tránh: (1) **bảng *Tuỳ chọn* phải khoá cùng lúc** — nó cho tự chỉnh đủ tám thứ nên mở ra là dựng lại được mức Rất khó bằng tay, ba ổ khoá kia thành trang trí; (2) **phải kẹp lựa chọn ở chỗ ĐỌC, không chỉ chặn ở chỗ bấm** — lựa chọn nằm trong `localStorage` của máy người học nên bản đã lưu có thể là mức trả phí từ trước (hết đợt thử nghiệm, đổi tài khoản, hoặc sửa tay trong bảng điều khiển trình duyệt), `allowedDrillOptions` lo việc đó; (3) **mức khoá vẫn hiện ra kèm ổ khoá chứ không bị ẩn** — ẩn thì người học không biết có gì ở sau, mà đó lại đúng là thứ cần biết để quyết định mở gói, và chip bị `disabled` thì cú chạm không phát ra sự kiện nào nên không nói được vì sao nó khoá. Mức Dễ **không được cắt thành bản demo cụt**: nó là đường thu hút người chưa mua ở Giai đoạn C |
| Người học hết bài để tập thì lấy bài ở đâu? | **Kho ôn luyện `/review/[chương]`** — gọi thẳng bộ sinh đã có sẵn, mỗi lần bấm một bài mới, hạt giống nằm trong đường dẫn | Bộ sinh (`exercise-gen.ts`) đã xong từ lâu mà **không có chỗ nào gọi nó**, nên người học không hề biết là có. Dựng cửa vào rẻ hơn hẳn mọi cách khác để có thêm bài: không phải xin phép ai, không phải soạn tay, và bài nào cũng đúng tầm nốt của chương. **Hạt giống trong ĐƯỜNG DẪN, không bốc số lúc vẽ:** bốc lúc vẽ thì tải lại trang là mất bài đang tập — hỏng theo kiểu người học không hiểu vì sao. Cùng lý do đó, nút *Bài khác* tính hạt giống kế tiếp bằng một phép nhân-cộng-lấy-dư (`nextSeed`) nên nó chỉ là một thẻ `<a>` do máy chủ dựng sẵn, không cần JavaScript. Ranh giới trả phí trùng đúng ranh giới nội dung (`canReviewChapter` dùng lại `FREE_THROUGH_CHAPTER`), không đẻ thêm hàng rào mới |
| Kho bài hát ít bài vì chưa xin được bản quyền — cho người học tự đưa bản nhạc vào được không? | **Được, và đã làm: `Kho nhạc của tôi`** (`/my-sheets`) — nhập file `.mid`/`.musicxml`, hoặc chụp ảnh bản nhạc giấy. Riêng tư tuyệt đối, không có đường chia sẻ | Câu này **đổi chiều chuyện bản quyền** chứ không né nó: app thôi làm người phát hành và thành **nơi chứa**, vị trí có cơ chế miễn trừ trong Nghị định 17/2023 — giữ được nhờ bốn điều ghi ở mục 7 của `ban-quyen-bai-hat.md` và ở đầu `src/lib/user-sheets.ts`. **Vì sao nhận cả hai đường:** file nhạc đọc ra nốt nên dùng lại được **nguyên** `SheetViewer` (nghe mẫu, tập với đàn, tô xanh) mà không phải dựng gì mới — nhưng người học Việt Nam phần lớn chỉ có sách giấy, nên phải có đường chụp ảnh, và nó cũng là đường duy nhất chạy trên iPhone. **Cố ý KHÔNG làm nhận dạng nốt từ ảnh (OMR):** ảnh chụp điện thoại (giấy cong, bóng đèn, chụp nghiêng) sai thường xuyên, mà sai một nốt thì người học tập sai cả câu và không ai báo — đúng bẫy 25. Thà nói thẳng "ảnh chỉ để đọc" còn hơn hứa thứ máy làm không nổi. Ảnh lưu thẳng trong Postgres, không thuê kho file: ngưỡng phải đổi ý ghi ở `src/db/schema/sheets.ts` |
...
| Có nên bắt người học tập đạt bài trước (ví dụ: nối đàn và qua được bài tập) mới mở bài sau? | **Không khoá.** Thay bằng ba thứ không chặn: mục **Xong bài khi** đứng ngay trên nút tick, **dòng nhắc** khi mở một bài đứng sau bước chưa tick (bấm *Học tiếp* là thôi nhắc ở bài đó), và **dòng khen** khi đã đánh trọn một bản nhạc của bài với đàn | Chủ sản phẩm hỏi 14/09/2026 vì thấy một người beta tick 3 bài mà đã tới Chương 3, và lo người học lười. Năm lý do không khoá: (1) `AGENTS.md` cấm bắt buộc cho app nghe đàn — iPhone không có Web MIDI; (2) micro **chưa đo trên máy thật**, bắt đạt là để người học kẹt vì lỗi của app, đúng kiểu kẹt dễ bỏ nhất; (3) người lười gặp ổ khoá thì bỏ app chứ không tập, mà tick vẫn không chứng minh được là đã tập; (4) đang beta, ổ khoá trộn "rơi vì bị chặn" với "rơi vì nội dung" — đúng con số đợt beta sinh ra để đo; (5) ngược mục 0 của `dinh-huong-kinh-doanh.md`: người học tự quyết tập lại đoạn nào. Chỗ thiếu thật lại nằm ở nội dung: Chương 2-4 chỉ dặn *cách tập* ("đánh đi đánh lại 15 lần") mà không nói *tới đâu là xong*, nên người chăm chỉ cũng không biết lúc nào tick. Nhảy cóc mới thấy ở một người, chưa rõ vì lười hay vì đã biết chơi — hỏi người đó trước khi làm gì thêm. Dòng khen lưu trên máy (`localStorage`), không vào database: mất đi thì không ai mất gì, tiến độ thật vẫn là nút tick |
| Học lý thuyết trước rồi mới tập, hay tập trước? | **Tập trước, lý thuyết thành đọc thêm.** Bài lý thuyết ra khỏi đường đi (không tick, không đếm tiến độ, là nút *Đọc thêm* cuối trang chương). Bài tập mở ra là bản nhạc, mỗi bài tập 1-2 dòng hướng dẫn, phần tập mặt bàn - luyện tai - "vì sao" gom xuống mục *Đọc thêm* cuối bài. Làm Chương 1-2 trước, chờ chủ sản phẩm đọc thử rồi mới làm Chương 3-7 | Chủ sản phẩm thấy nội dung "nhiều chữ và lý thuyết quá", kể lại cách học hồi đại học: thực hành trước, ai muốn thì đọc lý thuyết. Đo trước khi sửa: mỗi bài tập khoảng 70% là chữ, bài lý thuyết 70-130 dòng đứng chắn đầu mỗi chương và phải tick — người học phải đọc cả trang chữ mới được chạm phím, và từ khi có dòng nhắc vượt bài thì người bỏ qua lý thuyết còn bị nhắc. **Lật một nửa quyết định "gom thành Đường đi" ngày 11/09:** vẫn gom bài tập và tick vào một đường đi theo chương, nhưng bỏ vế "lý thuyết đứng đầu, tick được". Thứ bắt buộc phải biết để tập (Đô giữa ở đâu, số ngón, nốt trắng giữ mấy nhịp) chuyển vào bài tập, đúng chỗ cần, kèm hình. Bản nhạc giữ nguyên từng ký tự và slug không đổi, nên tiến độ đã tick không mất; tick cũ của bài lý thuyết vẫn nằm trong database nhưng không đếm nữa. `beta-metrics.mjs` vốn chỉ đếm bài tập nên chỉ số quyết định không đổi. Làm thử hai chương trước vì người beta đang ở đó, và vì viết sai khuôn cho cả 25 bài thì phải sửa lại cả 25 **Bổ sung cùng ngày:** chỉ nói "không bắt buộc" là chưa đủ — nó cho người học biết được phép bỏ qua, nhưng không nói lúc nào thì nên đọc. Chủ sản phẩm chốt cách nói: *tập thử trước, thấy cần hoặc khó hiểu thì tìm tới lý thuyết*, và phải **mời** người học làm vậy. Nên mọi chỗ dẫn tới phần giải thích đều gọi đúng khoảnh khắc đó: câu cuối đoạn mở bài ("Cứ tập thử trước; chỗ nào khó hiểu thì…"), tiêu đề mục cuối bài *Tập thấy khó? Đọc ở đây* kèm những chỗ hay vấp của chính bài đó, nút ở trang chương *Tập thấy khó hiểu? Đọc lý thuyết chương này*, và đầu trang lý thuyết "Nên tập thử trước khi đọc trang này" **Bổ sung cùng ngày (2):** chủ sản phẩm bảo làm tiếp, Chương 3-7 viết lại cùng khuôn — bỏ bước chờ duyệt bản thử. Bản nhạc cũ giữ nguyên từng ký tự bằng máy (khung chữ viết lại, khối nhạc chép lại từ bản trên `main` rồi so), mỗi bài thêm một khuông hoặc hình bàn phím nhỏ cho khái niệm mới, và `check:lessons` chuyển từ "chỉ gác bài theo khuôn mới" sang "mọi bài tập phải theo khuôn" |
| Chữ trong chương, bài học, bài ôn luyện dài tới đâu? | **Ngắn tới mức chỉ để dẫn vào việc tập.** Ưu tiên bản nhạc, hình bàn phím, bản nhạc nhúng và dẫn thẳng tới công cụ tập (*Tập bài này với đàn*, `/review`, luyện nhận nốt, máy đánh nhịp) hơn một câu giải thích. **Có máy gác:** `check:lessons` báo lỗi với bài theo khuôn mới khi đoạn mở bài quá 450 ký tự, chữ dẫn một phần tập quá 350, một đoạn cuối bài quá 300, hoặc bài tập không có bản nhạc hay hình | Chủ sản phẩm chốt để người học *"thực hành liên tục và hứng thú khi học bài và ôn luyện"* — mỗi đoạn chữ là một lần tay rời phím. Ghi thành luật trong `AGENTS.md` và skill `daily-practice-structure`, nhưng luật trên giấy trôi dần qua mỗi lần soạn bài mới, nên gác bằng máy. Ngưỡng đặt ngay trên bài dài nhất Chương 1-2 lúc chốt (420 / 336 / 272) chứ không lấy số tròn tuỳ ý, và chỉ áp cho bài đã theo khuôn mới (nhận ra bằng tiêu đề *Tập thấy khó? Đọc ở đây*) để Chương 3-7 chưa viết lại không đỏ oan. Vượt ngưỡng thì cắt chữ hoặc đổi thành hình, không nâng ngưỡng |
| Bản nhạc người học nhập vào nên ghi hoá biểu thế nào? | **Đọc thẳng hoá biểu file gốc khai** (meta `0x59` của MIDI, `<fifths>` của MusicXML), phủ đủ mười lăm giọng. **Không đoán từ các nốt, và KHÔNG cho người học đặt lại.** File không khai thì giữ `K: C` với dấu hoá cạnh từng nốt, như trước | Trước đây `toAbc` ghi cứng `K: C` rồi dán dấu hoá cạnh từng nốt — an toàn, nhưng bản nhạc bốn năm phím đen hiện ra gần như nốt nào cũng một dấu, đọc trên máy đặt ở giá nhạc không nổi. Chủ sản phẩm gửi ảnh chụp đúng cảnh đó 14/09/2026. **Bản đầu làm sai hướng:** dựng một ô chọn mười lăm giọng cho người học tự đặt, lập luận rằng hoá biểu chỉ đổi CÁCH VIẾT chứ không đổi cao độ nên chọn trật cũng vô hại. Chủ sản phẩm bác ngay hôm sau, và đúng: **hoá biểu là một phần của bản nhạc**, người soạn đã quyết bài ở giọng nào và mỗi dấu hoá đứng ở đâu — cho đặt lại là cho sửa bản nhạc của người ta, và người học sơ cấp không có cơ sở nào để chọn. Vô hại về cao độ không có nghĩa là đúng. Giữ lại phần đọc hoá biểu từ file, bỏ ô chọn. **Vì sao vẫn không đoán giọng từ các nốt:** đoán trật thì bản nhạc đầy dấu bình, trông còn rối hơn lúc chưa có hoá biểu, mà người học không biết thứ mình đang nhìn ở đâu ra — thà nhiều dấu mà trung thực với file. Hai chỗ phải giữ khi sửa tiếp: (1) **sổ dấu hoá của mỗi ô nhịp ghi bằng SỐ**, vì khi có hoá biểu thì một chữ cái viết trơn không còn nghĩa là nốt trắng (`F` ở giọng Sol trưởng là Pha thăng) — sổ cũ gộp hai thứ đó làm một và sẽ lệch nửa cung mà mọi lệnh kiểm vẫn xanh; (2) **`KEY_SIGNATURES` dùng chung cho cả bài luyện nhận nốt**, nên bảy giọng của Giai đoạn 1-2 đánh dấu bằng cờ `drill` — thêm giọng vào bảng không được làm bài tập khó lên sau lưng người học |
| Có tự làm phần cứng đàn không, và cây đàn đó có phát tiếng không? | **Có, khi đã có doanh thu — và cây đàn KHÔNG phát tiếng.** Đàn gập **61 phím, và 61 là nhỏ nhất** — không làm bản 49 phím. Cỡ phím chuẩn, có cảm ứng lực, nối điện thoại hoặc máy tính bằng dây và Bluetooth. **Tiếng do app phát**, không phải do đàn | Chủ sản phẩm nêu 15/09/2026: rào cản lớn nhất để app tới được người mới không phải nội dung mà là **cây đàn** — cồng kềnh và đắt. Hướng nhắm tới người chưa có đàn, tập ở bàn làm việc hoặc mang theo, chứ không phải người đã có cây đàn ở nhà. **Vì sao bỏ tiếng:** ở tầm giá này loa và mạch tiếng không thể hay, mà app đã có sẵn bộ tiếng piano nắn kỹ (`piano-tone.ts`) — để tiếng ở app thì tiếng hay hơn, giá đàn rẻ hơn, và cây đàn thành lý do dùng app. **Vì sao 61 là nhỏ nhất — có số đo:** quét toàn bộ 125 khối nhạc trong `docs/` ra tầm **Đô2..Đô6 = đúng 49 nửa cung** (bài ăn hết tầm là Canon in D). Đàn 49 phím (C2-C6) vì vậy chỉ vừa khít nội dung hôm nay, không dư một phím, và Giai đoạn 2 — tự đệm bài hát, bè tay trái hay xuống thấp — gần như chắc chắn sẽ vượt; bán ra một cây đàn mà giáo trình tự làm nó hết dùng được là tự phá uy tín. 61 phím (C2-C7) dư trọn một quãng tám. Ban đầu đã cân nhắc cả 49 phím vì gọn hơn; chủ sản phẩm chốt bỏ hẳn 49 khỏi kế hoạch cùng ngày. **Đừng đặt cỡ lạ (66 phím):** thị trường chỉ có 49/61/76/88, cỡ lạ nghĩa là không dùng được bộ phím sẵn của nhà máy, mà bộ phím mới là thứ đắt nhất. **Ba điều kiện không được bỏ:** phím cỡ chuẩn 2,3cm, có cảm ứng lực (không có thì Chương 5 vô nghĩa — xem `chon-dan-dau-tien.md`), hành trình phím đủ sâu. Phím nặng kiểu búa thì gập nhẹ không thể có, nên định vị là **đàn để bắt đầu và mang theo**, không thay cây đàn thật. **Hai cái giá đã chấp nhận, ghi ở mục 3:** iPhone/iPad tạm ngoài cuộc, và app phải phát được tiếng nốt người học bấm với độ trễ đủ thấp — việc thứ hai là điều kiện sống còn của cả hướng này |
| Tiếng "nghe mẫu" có được dùng nhạc cụ khác ngoài piano không? | **Không. Mọi tiếng phải là piano** — họ Piano của General MIDI, program 0-7. Muốn tiếng êm hơn thì **nắn tiếng chính cây piano ấy** (`src/lib/piano-tone.ts`), không mượn nhạc cụ khác | Chủ sản phẩm hỏi xin tiếng êm hơn 14/09/2026, và lần đầu làm sai hướng: đo phổ mười chín nhạc cụ rồi thêm vibraphone, đàn hạc, celesta vì chúng êm hơn Grand Piano rõ rệt. Gỡ ngay hôm sau. **Lý do gỡ:** đây là app dạy piano, nghe mẫu là để biết câu nhạc mình sắp đánh nghe ra sao **trên cây đàn của mình** — một tiếng chuông gõ nghe hay hơn nhưng nó không còn là thứ người học sắp đánh, và nó dạy tai họ một âm sắc không có thật trên cây đàn. **Thứ chủ sản phẩm thật sự muốn là "piano vang êm dịu" kiểu nhạc buồn**, mà không bộ mẫu âm nào có sẵn: mẫu âm nào cũng thu khô trong phòng tiêu âm, còn tiếng ấy = cây đàn đó + một căn phòng + chạm phím nhẹ. Nên làm bằng xử lý âm thanh, không bằng mẫu âm mới. **Hai chỗ đã dò sai rồi mới ra:** (1) cắt từ 1100Hz nghe êm thật nhưng Đô6 chỉ còn 52% — giai điệu ở bè cao nhất bị chìm dưới tay trái; phải cắt từ 2200Hz, vì cái gây chói là tiếng búa gõ nằm cao hơn nốt hai ba quãng tám, không phải cao độ của nốt; (2) tiếng vang để mức hút phần cao nhẹ như Freeverb gốc thì nó làm bản nhạc **sáng thêm** 5-8%, ngược hẳn thứ đang cần. Đo lại trên câu mở đầu Ode to Joy: phần chói trên 2kHz giảm 80%, chỗ trũng giữa hai nốt vẫn sâu -18,4dB nên tai vẫn đếm được từng nốt |
| Báo cho người học biết họ vừa được cấp gói bằng cách nào? | **App tự gửi thư** qua Resend, và lá thư đó **xin họ nhắn trước một câu trên Facebook** | Trước đó chỉ có hai đường, và cả hai đều thủng: nhắn tay thì phải nhớ, còn tấm thẻ trong app chỉ tới được người tự mở app lại. Thư lấp chỗ đó, nhưng giá trị lớn hơn nằm ở câu xin nhắn: **Trang Facebook không nhắn tin trước cho ai được** — Meta chỉ cho Trang trả lời trong 24 giờ sau khi người dùng nhắn — nên nếu không xin họ mở lời thì suốt đợt beta không có đường nào hỏi han người học cả. Xin bằng **một câu hỏi cụ thể** ("bạn đang tập trên cây đàn nào?") chứ không phải lời mời chung chung, vì "có gì cứ nhắn nhé" gần như không ai trả lời; chọn đúng câu đó vì câu trả lời còn dùng được thật — có cổng MIDI hay không quyết định nên chỉ họ nối dây hay nghe qua micro. Đặt trong thư vì đó là lúc người học sẵn lòng nhất: vừa được mở khoá. Thiếu khoá Resend thì app im lặng không gửi và báo lại ở màn hình quản trị, cố ý không để thư hỏng làm hỏng việc cấp quyền |
...
- ~~**Bộ sinh bài tập Chương 1-5 chưa có chỗ nào gọi nó.**~~ **Xong 13/09/2026:** trang
  `/review/[chapter]` đã dựng đúng như đề xuất — hạt giống trong đường dẫn, dựng ở máy chủ
  bằng `SheetViewer`, có *Bài khác*, có hàng chọn kiểu bài, và có luôn *Tập bài này với đàn*
  vì nó vốn nằm sẵn trong `SheetViewer`. Đường vào đặt ở cuối danh sách bước của mỗi chương.
  Bài *Có gì mới* đã viết (`2026-09-13-kho-on-luyen.md`).
- **Chương 6 trở lên chưa có luật sinh bài tập.** Chương 6 là chương dạy luồn ngón cái đi quá
  thế tay 5 ngón, nên tầm nốt, kiểu bài và cách dựng câu đều phải bàn lại — thêm một dòng vào
  `CHAPTER_RULES` là chưa đủ, và `scripts/check-lessons.mjs` cũng nới tầm từ đúng chương đó.
- **Nhập bản nhạc từ ngoài vào: đã có bộ đọc, còn thiếu đường cho NGƯỜI SOẠN.** 13/09/2026
  đã viết `src/lib/musicxml.ts` và `src/lib/midi-file.ts` (đọc ra `ImportedScore`, ghi ra ABC
  qua `toAbc`) cho *Kho nhạc của tôi*. Phần còn treo là việc **soạn nội dung**: một script
...
- **Đàn câm đẩy iPhone/iPad ra ngoài cuộc cho tới khi có đường khác.** Đàn không kêu thì micro
  ...
  một bản đàn sau này). **Đây chính là điều kiện lật lại câu "không làm app mobile"** ở mục 1:
  đo tỷ lệ người học dùng iOS trong Vercel Analytics trước, rồi mới quyết.
...
|---|---|---|
| 16/09/2026 | `feat: Thư báo mở khoá gói và đường nhắn Facebook cho người học` | Thêm một dòng vào mục 1: app tự gửi thư báo cấp gói, và thư xin người học nhắn trước một câu trên Facebook. Ghi kèm ràng buộc khiến quyết định này có hình dạng như vậy — Trang không nhắn trước cho ai được, nên câu trả lời của người học là thứ DUY NHẤT mở ra đường liên lạc. Không ghi thì lần sau có người thấy lời xin nhắn tin là thừa rồi gỡ đi, và mất đường liên lạc mà không ai biết vì sao |
...
| 15/09/2026 | `feat: Tiếng piano êm và vang cho phần nghe mẫu` | Thêm một dòng vào mục 1: mọi tiếng nghe mẫu phải là piano, muốn êm hơn thì nắn tiếng chính cây đàn đó chứ không mượn nhạc cụ khác. Ghi cả lần làm sai (thêm vibraphone, đàn hạc, celesta rồi gỡ) và hai tham số đã dò trượt, để lần sau không ai đi lại đúng hai vòng đó |
| 14/09/2026 | `docs(internal): Nhật ký phiên hoá biểu và quyết định không đoán giọng` | Thêm một dòng vào mục 1: hoá biểu của bản nhạc nhập vào do người học chọn, máy chỉ đọc khi file khai chứ không đoán từ các nốt. Ghi rõ vì sao quyết định cũ (`K: C` cứng) gỡ được — viết lại nốt theo giọng nên chọn trật không còn lệch cao độ — để lần sau không ai đọc chú thích cũ rồi tưởng chuyện này đã cấm, và cũng không ai thêm phần tự đoán giọng |
| 14/09/2026 | `feat: Viết lại Chương 3-7 theo khuôn tập trước, ít chữ` | Bổ sung lần hai vào dòng quyết định "tập trước": Chương 3-7 đã viết lại theo cùng khuôn mà không chờ bản thử, kèm cách giữ bản nhạc nguyên văn và việc máy gác chuyển sang bắt buộc — để ai đọc dòng cũ "làm Chương 1-2 trước" không tưởng Chương 3-7 còn khuôn cũ |
| 14/09/2026 | `feat: Bài học ít chữ, tập liên tục — có máy gác độ dài chữ` | Thêm một dòng vào mục 1: chữ trong bài chỉ để dẫn vào việc tập, ưu tiên bản nhạc - hình - công cụ tập, kèm ba ngưỡng ký tự mà `check:lessons` gác và lý do chọn đúng ba con số đó — để lần sau có bài vượt ngưỡng thì người sửa cắt chữ chứ không nâng số |
| 14/09/2026 | `feat: Bài học ít chữ, tập liên tục — có máy gác độ dài chữ` | Bổ sung vào dòng quyết định "tập trước": cách nói phải là lời mời *tập thử trước, khó hiểu thì vào đây*, không chỉ là "không bắt buộc" — ghi kèm bốn chỗ đã đổi chữ, để Chương 3-7 viết lại theo đúng giọng đó |
| 14/09/2026 | `feat: Tập trước, lý thuyết thành đọc thêm — viết lại Chương 1-2` | Thêm một dòng vào mục 1: tập trước, lý thuyết thành đọc thêm — kèm số đo trước khi sửa, và ghi rõ đây là lật một nửa quyết định "gom thành Đường đi" ngày 11/09, để lần sau không ai đọc dòng cũ rồi đưa lý thuyết quay lại đầu chương |
| 14/09/2026 | `feat: Tiêu chí xong bài, nhắc khi vượt bài, khen khi đánh trọn với đàn` | Thêm một dòng vào mục 1: không khoá bài sau theo bài trước, kèm năm lý do và ba thứ thay vào — để lần sau có ai đề xuất "bắt qua bài mới cho học tiếp" thì đọc lý do trước chứ không dựng ổ khoá rồi mới thấy nó phá con số của đợt beta |
| 13/09/2026 | `docs(internal): Ghi quyết định cho kho ôn luyện và kho nhạc của tôi` | Thêm hai dòng quyết định vào mục 1 (kho ôn luyện `/review`, và Kho nhạc của tôi `/my-sheets`) kèm lý do cho từng lựa chọn dễ bị lật lại sau này: hạt giống nằm trong đường dẫn, ranh giới trả phí dùng lại `FREE_THROUGH_CHAPTER`, nhận cả file nhạc lẫn ảnh chụp, và **không** làm nhận dạng nốt từ ảnh. Đánh dấu hai việc còn treo đã xong, và ghi lại phần còn lại của việc nhập bản nhạc (script soạn nội dung cho `/songs`, bộ đọc LilyPond) |
...
| 12/09/2026 | `feat: Xoay ngang thì thanh điều hướng dời sang cạnh trái, thu gọn còn biểu tượng` | Mục 1 thêm dòng về thanh điều hướng dọc lúc xoay ngang: chốt lý do đổi hướng (xoay ngang thì chiều cao khan hiếm còn bề ngang thừa), lý do chọn mép trái, và ghi lại bản ĐÈ lên nội dung đã dựng xong rồi bỏ vì che mất phần đầu mọi dòng chữ |
| 12/09/2026 | `feat: Bốn mức khó dựng sẵn cho bài luyện nhận nốt, bảng chi tiết gộp vào Tuỳ chọn` | Mục 1 thêm dòng về bốn mức khó dựng sẵn: chốt thang bám theo lộ trình giáo trình chứ không bịa cho đủ bốn bậc, chốt mỗi bậc chỉ thêm hai tới ba thứ, và chốt mức phải SUY RA từ lựa chọn chứ không lưu riêng — lưu riêng thì nhãn và lựa chọn lệch nhau được. Kèm số đo: thẻ bảng chọn từ 1237px xuống 278px |
