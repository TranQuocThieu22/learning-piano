...
- **Bộ sinh bài tập Chương 1-5 đã xong nhưng chưa có chỗ nào gọi nó.** Việc người học
  nhìn thấy — kho ôn luyện hiện ra sau khi học xong một bài hay một chương — chưa dựng. Đề
  xuất đang chờ quyết: trang `/review/[chapter]` lấy `seed` từ đường dẫn, dựng ở máy chủ bằng
  `SheetViewer`, kèm nút *Bài khác* và *Tập bài này với đàn* qua micro. Chừng nào chưa có trang
  thì **đừng viết bài *Có gì mới***: mục đó kể bằng việc người học làm được.
...
- **Nhập bản nhạc từ ngoài vào (MusicXML) chưa làm.** Đã đề xuất hai lần và chưa quyết: một
  script đổi MusicXML sang ABC để lấy bài từ `musetrainer/library`, và nhập thử **một** bài
  Mutopia (LilyPond → ABC) qua đủ ba lớp kiểm ở mục 6 của `ban-quyen-bai-hat.md`. Việc này
